...
def preprocess_document(fname):
    ...
    tokens_without_stopwords = [word for word in text_tokens if word not in stopwords.words()]
...
def main():
    ...
    for i in range(1,4):
        preprocessed_doc = preprocess_document("./Document Preprocessing/Text"+str(i)+".txt")
